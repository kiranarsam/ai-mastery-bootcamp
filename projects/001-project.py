...
# Description: It predicts continuous values - like house prices -
# based on size, num of bedrooms, location, etc.
# Predicts house area's with square feet.
...
print("X: ", X) # Area in square feet
print("y: ", y) # House price in $1000s
